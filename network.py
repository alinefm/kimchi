...
APrivateNets = ipaddress.IPv4Network('10.0.0.0/8')
BPrivateNets = ipaddress.IPv4Network('172.16.0.0/12')
CPrivateNets = ipaddress.IPv4Network('192.168.0.0/16')
PrivateNets = [CPrivateNets, BPrivateNets, APrivateNets]
DefaultNetsPool = [ipaddress.IPv4Network('192.168.122.0/23'),
                   ipaddress.IPv4Network('192.168.124.0/22'),
                   ipaddress.IPv4Network('192.168.128.0/17')]
